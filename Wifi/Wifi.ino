...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "AlmeriaTS";  // You will connect your phone to this Access Point
...
#ifdef MODE_STA
// For STATION mode:
const char *ssid = "AlmeriaTS";  // Your ROUTER SSID
const char *pw = "mandakiwis"; // and WiFi PASSWORD
const int port = 9876;

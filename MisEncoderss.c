 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Feb 01 16:14:38 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MisEncoderss
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const int32_T *enc = (const int32_T *) mxGetData(PARAM_DEF0(S));
    const int32_T *pinA = (const int32_T *) mxGetData(PARAM_DEF1(S));
    const int32_T *pinB = (const int32_T *) mxGetData(PARAM_DEF2(S));
    
    MisEncoderss_Outputs_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    MisEncoderss_Update_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
